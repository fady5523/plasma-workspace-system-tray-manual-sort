...
private:
    ...
    void ensureManualOrderContainsAllItems();
    SortedSystemTrayModel::SortingType sortingTypeForCurrentMode() const;
    SortedSystemTrayModel::SortingType configSortingTypeForCurrentMode() const;
