...
public:
    ...
    const QStringList manualOrder() const;
    void setManualOrder(const QStringList &order);
    const QString orderingMode() const;
    void setOrderingMode(const QString &mode);
    bool reverseIconOrder() const;
    bool respectDirection() const;
